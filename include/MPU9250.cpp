...
void MPU9250::begin() {
  ...
  Serial.print("MPU9250 "); Serial.print("I AM "); Serial.println(c, HEX);
...
float MPU9250::acc_x_axis() {
  return (int)1000 * ax;
}
float MPU9250::acc_y_axis() {
  return (int)1000 * ay;
}
float MPU9250::acc_z_axis() {
  return (int)1000 * az;
}

float MPU9250::gyro_x_deg() {
  return gx;
}
float MPU9250::gyro_y_deg() {
  return gy;
}
float MPU9250::gyro_z_deg() {
  return gz;
}

float MPU9250::mag_x_mG() {
  return (int)mx;
}
float MPU9250::mag_y_mG() {
  return (int)my;
}
float MPU9250::mag_z_mG() {
  return (int)mz;
}
