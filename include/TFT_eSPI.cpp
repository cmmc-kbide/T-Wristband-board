...
***************************************************************************************/
void TFT_eSPI::drawXBitmap(int16_t x, int16_t y, const uint16_t *bitmap, int16_t w, int16_t h, uint16_t color)
{
  spi_begin();
  inTransaction = true;
...
***************************************************************************************/
void TFT_eSPI::drawXBitmap(int16_t x, int16_t y, const uint16_t *bitmap, int16_t w, int16_t h, uint16_t color, uint16_t bgcolor)
{
  spi_begin();
  inTransaction = true;
...
void TFT_eSPI_Button::drawButton(boolean inverted) {
  ...
  uint8_t r = TFT_min(_w, _h) / 4; // Corner radius
