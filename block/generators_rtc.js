...
Blockly.JavaScript['pcf8563_rtc_get_hour'] = function(block) {
  var code = `#LOOP_EXT_CODERTC_Date datetime = rtc.getDateTime();#ENDdatetime.hour`;
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['pcf8563_rtc_get_minute'] = function(block) {
  var code = `#LOOP_EXT_CODERTC_Date datetime = rtc.getDateTime();#ENDdatetime.minute`;
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['pcf8563_rtc_get_secound'] = function(block) {
  var code = `#LOOP_EXT_CODERTC_Date datetime = rtc.getDateTime();#ENDdatetime.second`;
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['pcf8563_rtc_get_day'] = function(block) {
  var code = `#LOOP_EXT_CODERTC_Date datetime = rtc.getDateTime();#ENDdatetime.day`;
  return [code, Blockly.JavaScript.ORDER_NONE];
};
Blockly.JavaScript['pcf8563_rtc_get_month'] = function(block) {
  var code = `#LOOP_EXT_CODERTC_Date datetime = rtc.getDateTime();#ENDdatetime.month`;
  return [code, Blockly.JavaScript.ORDER_NONE];
};
Blockly.JavaScript['pcf8563_rtc_get_year'] = function(block) {
  var code = `#LOOP_EXT_CODERTC_Date datetime = rtc.getDateTime();#ENDdatetime.year`;
  return [code, Blockly.JavaScript.ORDER_NONE];
};
